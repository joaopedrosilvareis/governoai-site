---
titulo: "Reforma Laboral: Trabalho XXI chega ao Parlamento"
data: 2026-05-08
numero: 1
tema: Trabalho
sumario: "Concertação social fechou sem acordo. Governo enviou para a AR pacote com mais de 100 alterações ao Código do Trabalho, com greve geral marcada para 22 de maio. Sessão produz acordo AD+PS+Livre+PAN com 156 deputados."
...
quick_facts:
  ...
  - label: "Greve geral"
    value: "22 mai · CGTP"
  - label: "Maioria atingida"
    value: "156 deputados (+40)"
  - label: "Geometria final"
    value: "AD + PS + Livre + PAN"
posicoes:
  - partido: AD
    deputados: 91
    frase: "Reforma necessária. Abre em três pontos. Banco de horas individual e ACT intocáveis."
  - partido: Chega
    deputados: 60
    frase: "Sem proteção parental e idade da reforma aos 65, chumbamos. Ligado ao OE2027."
  - partido: PS
    deputados: 58
    frase: "Três linhas vermelhas: outsourcing 12m, banco de horas com IRCT, reintegração com salvaguardas."
  - partido: IL
    deputados: 9
    frase: "Exigimos componente fiscal: IRC 19%, IRS Jovem, ACT vinculativa."
  - partido: Livre
    deputados: 6
    frase: "Direito a desligar, semana de 4 dias-piloto, transição justa."
  - partido: PCP
    deputados: 3
    frase: "Rejeição integral. A resposta está na greve de 22 de maio."
  - partido: PAN
    deputados: 1
    frase: "Direito a desligar, licença alargada, avaliação de impacto na conciliação."
  - partido: BE
    deputados: 1
    frase: "Rejeição integral. É capitulação com selo progressista."
cenarios:
  provavel:
    titulo: "Acordo ao centro com viabilizadores"
    geometria: "AD + PS + Livre + PAN = 156"
    sumario: "Outsourcing a 9 meses, banco de horas com IRCT, reintegração à opção do trabalhador, plataformas reguladas, ACT vinculativa."
    chave: "AD aceita literalmente redação do PS no banco de horas"
  consenso:
    titulo: "Pacto trilateral europeu"
    geometria: "230 dep. (hipotético)"
    sumario: "Pacote laboral + diploma fiscal paralelo + grupo de trabalho sobre carreiras longas. Cada partido com cedência e dois ganhos."
    chave: "Recomendação UE + mobilização social a 22 mai"
  impasse:
    titulo: "Bloco da direita ou bloqueio"
    geometria: "< 116 dep. ou AD+Chega+IL = 160"
    sumario: "A AD endurece, PS recusa, Chega exige 65 anos. Pacote cai ou avança com Chega ao preço de OE2027 envenenado."
    chave: "Calendarização da reforma aos 65"
takeaway: "O PS sai mais forte — <strong>travou o pacote regressivo sem assumir custo de bloqueio</strong>, e fixou a redação do banco de horas. A AD ganha um diploma aprovável mas <strong>perde o eixo direita</strong> e prepara um outono difícil. O Chega sai com narrativa intacta mas sem ganhos concretos — moeda guardada para o OE2027."
---
